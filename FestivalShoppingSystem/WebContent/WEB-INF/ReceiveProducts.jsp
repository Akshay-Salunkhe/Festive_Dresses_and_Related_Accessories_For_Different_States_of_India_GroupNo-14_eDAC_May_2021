...
    chapterSel.length = 1;
  ...
  <%
	...
	if (request.getParameter("card_number") != null) {
		out.println("<script>alert('Payment Successfull and your order has been placed successfully')</script>");
	}
%>
  ...
  <li><a href="/ReceiveProducts" >Home</a></li>
	...
	<div class="form-group col-md-2">
     ...
     <div class="form-group col-md-1">
       ...
       <button class="form-contr
       ol btn btn-primary" id="myInput" onclick="SearchData();">Filter</button>
    </div>
